...
public class Match_camera extends AppCompatActivity {
    ...
    private void showAlert() {
        AlertDialog alertDialog = new AlertDialog.Builder(Match_camera.this).create();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "ALLOW",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        ActivityCompat.requestPermissions(Match_camera.this,
                                new String[]{Manifest.permission.CAMERA},
                                MY_PERMISSIONS_REQUEST_CAMERA);
                    }
                });
    ...
    private void showSettingsAlert() {
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SETTINGS",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        startInstalledAppDetailsActivity(Match_camera.this);
                    }
                });
                ...
                for (int i = 0, len = permissions.length; i < len; i++) {
                    ...
                    if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                        ...
                        if (showRationale) {
                            ...
                            // the app setting
                            saveToPreferences(Match_camera.this, ALLOW_KEY, true);
                        }
                    }
                }
            }
